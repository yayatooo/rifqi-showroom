...
export default function Listvehicle({ vehicles, deletVehicle, fetchData }) {
        ...
        <table className="min-w-full text-center">
          <thead>
            <tr className="bg-gray-200 text-gray-700">
              ...
              <th className="py-2 px-4">First Price</th>
            ...
            return (
              <tbody key={i}>
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-2 px-4">{rupiah(data.firstPrice)}</td>
                  <td className="py-2 px-4">{rupiah(data.servicePrice)}</td>
                  <td className="py-2 px-4 text-green-500">
                    {rupiah(getTotalPrice(data))}
                  </td>
